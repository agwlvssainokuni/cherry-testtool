...
const StubconfigPage = () => {
  ...
  const handlePeekBtn = () =>
    getStub(className, methodName, methodIndex)
      .then((r: string[]) => {
        setScript(r[0])
        setEngine(r[1])
        setResult(r[2])
  ...
  const handleRegisterBtn = () =>
    putStub(className, methodName, methodIndex, script, engine)
      .then((r: string) => {
        setResult(r)
      })
      .catch((r) => {
  ...
  return (
    <div className="stubconfig-page">
      <h1 className="stubconfig-page-title">スタブ設定ツール</h1>
      ...
      <div className="stubconfig-form">
        ...
        <div className="stubconfig-actions-row">
          ...
          <Button
            ...
            className="stubconfig-register-button"
            data-testid="stubconfig-register-button"
          >
            登録
          </Button>
        </div>
