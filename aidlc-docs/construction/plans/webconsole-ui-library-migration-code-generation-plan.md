...
- [ ] **Step 5**: `src/layouts/AppShellLayout.tsx`を新設する
...
- [ ] **Step 7**: `src/pages/Home/HomePage.tsx`・`src/pages/Home/HomePage.css`を新設する
...
- [ ] **Step 8**: `src/pages/Invoker/`(`InvokerPage.tsx`・`InvokerPage.css`・`api.ts`)を新設する
...
- [ ] **Step 9**: `src/pages/Stubconfig/`(`StubconfigPage.tsx`・`StubconfigPage.css`・`api.ts`)を新設する
